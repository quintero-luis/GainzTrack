...
final class ExerciseSetUseCasesMock: ExerciseSetUseCasesProtocol {
    private var repository: MockExerciseSetRepository
    
    init(repository: MockExerciseSetRepository = MockExerciseSetRepository()) {
        self.repository = repository
    }
